...
type ChannelLinkConfig struct {
	...
	// NotifyShutdownSent is used by the link to notify an outside
	// subsystem that Shutdown has been sent. This is not used during
	// retransmission. It takes a quit chan that is used as a precaution to
	// avoid deadlock.
	NotifyShutdownSent func(req *ChanClose, quit chan struct{})
...
func (l *channelLink) htlcManager() {
	...
	for {
		...
		if (l.shutdownInit || l.shutdownReceived) && !l.shutdownSent &&
			...
			l.cfg.NotifyShutdownSent(closeReq, l.quit)
